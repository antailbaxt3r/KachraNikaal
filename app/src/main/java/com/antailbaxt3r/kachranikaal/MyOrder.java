...
public class MyOrder extends AppCompatActivity {
    ...
    private DatabaseReference userReference, shopReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new MyOrderRVAdapter(getApplicationContext(), itemList);
        ...
        cancelOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MyOrder.this, "Order Cleared", Toast.LENGTH_SHORT).show();
                finish();
    ...
    public void requestPayment(View view) {
        ...
        String price = PaymentsUtil.microsToString(Long.parseLong(finalCost.getText().toString()) * 1000000);
    ...
    private void attachID() {
        ...
        finalCost = findViewById(R.id.total_price_my_order);
        placeOrder = findViewById(R.id.place_order_btn);
        cancelOrder = findViewById(R.id.cancel_order_button);

        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        recyclerView = findViewById(R.id.order_rv);

        userReference = FirebaseDatabase.getInstance().getReference().child("Users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("order");
